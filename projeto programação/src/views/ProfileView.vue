...
<template>
  ...
  <div class="title">
    ...
    <div v-if="user">
      ...
      <RouterLink to="/admin" v-if="user.role === 'admin'"
        >abrir painel de admin</RouterLink
      >
      ...
      <button class="login-btn" @click="deleteAccount">Apagar Conta</button>
    ...
    <p v-else>Nenhum utilizador com sessão iniciada.</p>
  </div>
</template>
